...
if __name__ == "__main__":
    ...
    wooden_box_robot = robot.getSelf()

    wooden_box_height = get_object(wooden_box_robot, 'wooden box').getField('size').getSFVec3f()[2]

    # Initialize position variables
    x = wooden_box_robot.getField('translation').getSFVec3f()[0]
    y = wooden_box_robot.getField('translation').getSFVec3f()[1]
    z = wooden_box_robot.getField('translation').getSFVec3f()[2]
    rotation_angle = 0
    ...
    while robot.step(timestep) != -1:
        ...
        gps_values[2] = gps_values[2] - wooden_box_height/2 # Needed because the GPS sensor is at the center of the wooden_box, not at the bottom
        ...
        wooden_box_robot.getField('translation').setSFVec3f([x, y, z])
        wooden_box_robot.getField('rotation').setSFRotation([0, 0, 1, rotation_angle])
